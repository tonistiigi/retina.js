(function() {
  var DefaultParser, StaticParser, activate_element, add_parser, clear_parsers, ignore_element, parsers, remove_parser, retina, scan, set_manual_mode, set_parser, _current_zoom_level, _get_zoom_level;
  ...
  _get_zoom_level = function() {
    ...
    userAgent = ((_ref = this.navigator) != null ? _ref.userAgent : void 0) != null;
    if (this.window && userAgent.match(/Webkit/i)) {
      if (userAgent.match(/Mobile/i)) {
        screenWidth = (_ref2 = this.orientation) === 0 || _ref2 === 180 ? this.screen.width : this.screen.height;
        if (this.devicePixelRatio) screenWidth *= this.devicePixelRatio;
        return this.window.innerWidth / screenWidth;
      } else {
        return this.window.innerWidth / this.document.width;
      }
    } else {
      return 1;
    }
